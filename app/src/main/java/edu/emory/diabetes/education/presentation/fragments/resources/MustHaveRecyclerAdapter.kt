...
class MustHaveRecyclerAdapter: ListAdapter<MustHaveAppPage, MustHaveRecyclerAdapter.MustHaveViewHolder>(diffUtil) {
    ...
    companion object{
        private val diffUtil = object : DiffUtil.ItemCallback<MustHaveAppPage>(){
            override fun areItemsTheSame(
                oldItem: MustHaveAppPage, newItem: MustHaveAppPage): Boolean {
                return newItem == oldItem
            }

            override fun areContentsTheSame(oldItem: MustHaveAppPage, newItem: MustHaveAppPage): Boolean {
