    ...
    val listOfStories = listOf(
        FourOrientation(
            ...
            "The hospital did great trying to prepare us for diabetes management. My child has not been overwhelmed with all the" +
                    ...
                    "informative—we are so new to this!"
        ),
        FourOrientation(
            "Child age 10",
        ...
        FourOrientation(
            "Child age 9",
            "The diabetes training classes were so helpful in preparing us to manage our daughters diagnosis. " +
                    "We are very grateful for the amazing care and training provided by CHOA. We are thankful to have so much help with " +
                    "this new diagnosis for our son. Thank you!"
        ),
        FourOrientation(
            "Child age 4",
            "I feel everything has been covered. I am very gratetful to all of the insight and the support. " +
                    "It feels great to know we have childrens healthcare of Atlanta and their staff to help us along the way."
        ),
        FourOrientation(
            "Child age 13",
